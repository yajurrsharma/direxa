...
def iqtest_com():
  ...
  questions = [
      ...
      {
        "question": "Which of the following is not a feature of a trial balance?",
        "options": ["a) It is a statement", "b) It has debit and credit columns", "c) It is an account", "d) It helps in preparing final accounts"],
        "answer": "c",
        "subject": "Accountancy"
      },
      {
        "question": "If wages are paid for installation of machinery, they should be:",
        "options": ["a) Debited to Wages A/c", "b) Debited to Profit & Loss A/c", "c) Debited to Machinery A/c", "d) Ignored"],
        "answer": "c",
        "subject": "Accountancy"
      },
      {
        "question": "A cheque deposited but not credited by the bank will be:",
        "options": ["a) Added to cash book balance", "b) Deducted from cash book balance", "c) Added to pass book balance", "d) Deducted from pass book balance"],
        "answer": "d",
        "subject": "Accountancy"
      },
      {
        "question": "Which of the following errors is not revealed by trial balance?",
        "options": ["a) Error of omission", "b) Error of principle", "c) Error of commission", "d) Compensating error"],
        "answer": "a",
        "subject": "Accountancy"
      },
      {
        "question": "Capital expenditure is shown in the:",
        "options": ["a) Trading account", "b) Profit and loss account", "c) Balance sheet", "d) Cash book only"],
        "answer": "c",
        "subject": "Accountancy"
      },
      {
        "question": "A liability that may or may not arise in future is called:",
        "options": ["a) Fixed liability", "b) Current liability", "c) Contingent liability", "d) Outstanding liability"],
        "answer": "c",
        "subject": "Accountancy"
      },
      {
        "question": "Which concept assumes that business will continue for a long time?",
        "options": ["a) Money Measurement Concept", "b) Going Concern Concept", "c) Matching Concept", "d) Dual Aspect Concept"],
        "answer": "b",
        "subject": "Accountancy"
      },
      {
        "question": "Rent paid in advance is:",
        "options": ["a) A liability", "b) An income", "c) A current asset", "d) An expense"],
        "answer": "c",
        "subject": "Accountancy"
      },
      {
        "question": "Goods costing ₹1,000 were taken by the proprietor for personal use. The journal entry will be:",
        "options": ["a) Drawings A/c Dr. ₹1,000; To Sales A/c ₹1,000", "b) Drawings A/c Dr. ₹1,000; To Purchases A/c ₹1,000", "c) Purchases A/c Dr. ₹1,000; To Drawings A/c ₹1,000", "d) Sales A/c Dr. ₹1,000; To Drawings A/c ₹1,000"],
        "answer": "b",
        "subject": "Accountancy"
      },
      {
        "question": "Goods worth ₹5,000 were returned by a customer, but were wrongly recorded as purchases returns. The effect of this error will be:",
        "options": ["a) Gross profit will increase", "b) Gross profit will decrease", "c) No effect on gross profit", "d) Net profit will increase"],
        "answer": "b",
        "subject": "Accountancy"
      },
      {
        "question": "A partnership firm continues to exist even after the death of a partner if there is:",
        "options": ["a) Unlimited liability", "b) Mutual agency", "c) Provision in the partnership deed", "d) Goodwill in the market"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "Which of the following documents is filed to register a company with the Registrar of Companies?",
        "options": ["a) Articles of Association only", "b) Memorandum of Association only", "c) Prospectus only", "d) All of the above"],
        "answer": "d",
        "subject": "Business Studies"
      },
      {
        "question": "A public company must issue a prospectus when:",
        "options": ["a) It wants to take loans", "b) It wants to invite the public to subscribe to shares", "c) It wants to register as a private company", "d) It wants to appoint directors"],
        "answer": "b",
        "subject": "Business Studies"
      },
      {
        "question": "Which of the following is a limitation of retained earnings?",
        "options": ["a) No dilution of control", "b) Increases creditworthiness", "c) May lead to inefficient use of funds", "d) Avoids issue costs"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "Which type of business is easiest to wind up?",
        "options": ["a) Cooperative society", "b) Partnership", "c) Sole proprietorship", "d) Company"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "Which of the following statements about joint stock companies is FALSE?",
        "options": ["a) It has separate legal existence", "b) Shareholders have limited liability", "c) All companies are listed on stock exchanges", "d) Ownership and management are separate"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "Who issues a Certificate of Commencement of Business?",
        "options": ["a) SEBI", "b) Registrar of Companies", "c) Ministry of Finance", "d) Board of Directors"],
        "answer": "b",
        "subject": "Business Studies"
      },
      {
        "question": "Which of the following is not a function of wholesalers?",
        "options": ["a) Risk bearing", "b) Grading of products", "c) Advertising to consumers", "d) Financing retailers"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "Equity shareholders are called real owners because:",
        "options": ["a) They get fixed dividends", "b) They receive interest", "c) They bear the ultimate risk", "d) They work as company directors"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "Which business organisation works on the principle of one man, one vote?",
        "options": ["a) Partnership", "b) Sole proprietorship", "c) Company", "d) Cooperative society"],
        "answer": "d",
        "subject": "Business Studies"
      },
      {
        "question": "Which feature of e-business makes it highly scalable?",
        "options": ["a) Cost-effectiveness", "b) Personalised experience", "c) Global reach", "d) Low need for physical space"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "The main feature distinguishing a Joint Hindu Family business from other forms is:",
        "options": ["a) Profit motive", "b) Membership through agreement", "c) Management by the eldest member", "d) Limited liability of all members"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "A private company must have a minimum of:",
        "options": ["a) 1 member", "b) 2 members", "c) 7 members", "d) 3 directors"],
        "answer": "b",
        "subject": "Business Studies"
      },
      {
        "question": "In which type of business risk is insurance most useful?",
        "options": ["a) Speculative risk", "b) Pure risk", "c) Financial risk", "d) Social risk"],
        "answer": "b",
        "subject": "Business Studies"
      },
      {
        "question": "Which principle of insurance limits the insured to recover only the actual amount of loss?",
        "options": ["a) Contribution", "b) Subrogation", "c) Utmost good faith", "d) Indemnity"],
        "answer": "d",
        "subject": "Business Studies"
      },
      {
        "question": "Which of the following statements is incorrect regarding a multinational company (MNC)?",
        "options": ["a) It has assets and operations in more than one country", "b) Its headquarters are always in a developing country", "c) It operates through branches or subsidiaries", "d) It brings foreign investment and technology"],
        "answer": "b",
        "subject": "Business Studies"
      },
      {
        "question": "Which one of the following is not a feature of departmental undertakings?",
        "options": ["a) Funded by annual government budget", "b) Managed by government officials", "c) Greater operational autonomy", "d) Directly under a ministry"],
        "answer": "c",
        "subject": "Business Studies"
      },
      {
        "question": "Which clause in the Memorandum of Association defines the scope of operations of the company?",
        "options": ["a) Name clause", "b) Liability clause", "c) Capital clause", "d) Object clause"],
        "answer": "d",
        "subject": "Business Studies"
      },
      {
        "question": "Which of the following services is considered auxiliary to trade?",
        "options": ["a) Warehousing", "b) Manufacturing", "c) Mining", "d) Assembly"],
        "answer": "a",
        "subject": "Business Studies"
      },
      {
        "question": "A major limitation of e-business is:",
        "options": ["a) Easy formation", "b) Paperless transactions", "c) Low operational cost", "d) Risk of data theft and hacking"],
        "answer": "d",
        "subject": "Business Studies"
      },
      {
